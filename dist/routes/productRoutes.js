 ...
 */
router.get('/products', verifyTokenMiddleware_1.verifyTokenMiddleware, productControllers_1.getAllProducts);
/**
 * @swagger
 * /api/products:
 *   post:
 ...
 */
router.post('/products', verifyTokenMiddleware_1.verifyTokenMiddleware, productControllers_1.createProduct);
/**
 * @swagger
 * /api/products/{id}:
 *   put:
 ...
 *         description: Erreur interne.
 */
router.put('/products/:id', verifyTokenMiddleware_1.verifyTokenMiddleware, productControllers_1.updateProduct);
